...
[![GoDoc](https://pkg.go.dev/badge/github.com/akralj/tag)](https://pkg.go.dev/github.com/akralj/tag)
...
[https://pkg.go.dev/github.com/akralj/tag#Sum](https://pkg.go.dev/github.com/akralj/tag#Sum)
...
```console
$ go install github.com/akralj/tag/cmd/tag@latest
$ cd $GOPATH/bin
